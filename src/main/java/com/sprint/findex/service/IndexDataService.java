...
public class IndexDataService {
    ...
    public IndexDataDto findById(UUID indexDataId) {
        IndexData indexData = indexDataRepository.findById(indexDataId)
                .orElseThrow(() -> new BusinessLogicException(ExceptionCode.INDEX_DATA_NOT_FOUND));
    ...
    public List<IndexDataDto> findAll() {
        // todo: CursorPageResponse
        return List.of();
    }
    ...
    public Resource export(UUID indexInfoId, LocalDate startDate, LocalDate endDate,
        ...
        List<IndexData> rows = indexDataRepository.findAllByIndexInfoIdAndCreatedAtBetween(
                indexInfoId,
                startDate,
                endDate,
                sort
        ...
        for (IndexData row : rows) {
            builder.append(row.getId()).append(',')
                    .append(row.getIndexInfo().getId()).append(',')
                    .append(row.getBaseDate()).append(',')
